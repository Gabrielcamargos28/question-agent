...
O design estrutural e a codificação do agente Python foram realizados de forma interativa. Com base na auditoria detalhada de prompts (\lstinline{all_prompts.md}), o processo foi guiado por três instruções-chave enviadas à IA:
\begin{itemize}
